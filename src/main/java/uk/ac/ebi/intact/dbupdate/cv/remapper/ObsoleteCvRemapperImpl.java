...
public class ObsoleteCvRemapperImpl implements ObsoleteCvRemapper{
    ...
    public void setOntologyIdToDatabase(Map<String, String> ontologyIdToDatabase) {
        this.ontologyIdToDatabase = ontologyIdToDatabase;
    }
