...
import uk.ac.ebi.intact.dbupdate.prot.listener.ProteinEventPersisterListener;
...
public class IntactUpdateContext implements DisposableBean, Serializable {
    ...
    @Autowired
    private ProteinEventPersisterListener proteinEventPersisterListener;
    ...
    public static void initStandaloneContextInMemory(ApplicationContext parent) {
        initContext(new String[]{"classpath*:/META-INF/dbupdate.spring.xml"}, parent);
    }
    ...
    public static void initContext(String[] configurationResourcePaths, ApplicationContext parent) {
        ...
        resourcesList.add("classpath*:/META-INF/dbupdate.spring.xml");
    ...
    public ProteinEventPersisterListener getProteinEventPersisterListener() {
        if (proteinEventPersisterListener == null) {
            throw new ConfigurationException("No bean of type " + ProteinEventPersisterListener.class.getName() + " found. One is expected");
        }
        return proteinEventPersisterListener;
    }
