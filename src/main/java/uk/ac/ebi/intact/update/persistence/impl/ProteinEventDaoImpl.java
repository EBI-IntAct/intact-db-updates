...
public class ProteinEventDaoImpl<T extends ProteinEvent> extends UpdateBaseDaoImpl<T> implements ProteinEventDao<T> {
    ...
    public List<T> getAllProteinEventsByName(EventName name) {
        final Query query = getEntityManager().createQuery( "select pe from "+ this.getEntityClass().getName() +" pe where pe.name = :name" );
    ...
    public List<T> getAllProteinEventsByProteinAc(String proteinAc) {
        final Query query = getEntityManager().createQuery( "select pe from "+ this.getEntityClass().getName() +" pe where pe.proteinAc = :ac" );
    ...
    public List<T> getAllProteinEventsByProcessId(long processId) {
        final Query query = getEntityManager().createQuery( "select pe from "+ this.getEntityClass().getName() +" pe join pe.parent as p where p.id = :id" );
    ...
    public List<T> getAllProteinEventsByDate(Date updatedDate) {
        final Query query = getEntityManager().createQuery( "select pe from "+ this.getEntityClass().getName() +" pe join pe.parent as p where trunc(p.date) = trunc(:date)" );
    ...
    public List<T> getAllProteinEventsByNameAndProteinAc(EventName name, String proteinAc) {
        final Query query = getEntityManager().createQuery( "select pe from "+ this.getEntityClass().getName() +" pe join pe.parent as p where p.proteinAc = :ac and pe.name = :name" );
        query.setParameter( "ac", proteinAc);
        query.setParameter( "name", name.toString());
    ...
    public List<T> getAllProteinEventsByNameAndProcessId(EventName name, long processId) {
        final Query query = getEntityManager().createQuery( "select pe from "+ this.getEntityClass().getName() +" pe join pe.parent as p where p.id = :id and pe.name = :name" );
        query.setParameter( "id", processId);
        query.setParameter( "name", name.toString());
    ...
    public List<T> getAllProteinEventsByProteinAcAndProcessId(String proteinAc, long processId) {
        final Query query = getEntityManager().createQuery( "select pe from "+ this.getEntityClass().getName() +" pe join pe.parent as p where p.proteinAc = :ac and p.id = :id" );
        query.setParameter( "ac", proteinAc);
        query.setParameter( "id", processId);
    ...
    public List<T> getProteinEventsByNameAndProteinAc(EventName name, String proteinAc, long processId) {
        final Query query = getEntityManager().createQuery( "select pe from "+ this.getEntityClass().getName() +" pe join pe.parent as p where p.proteinAc = :ac and pe.name = :name and p.id = :id" );
        query.setParameter( "ac", proteinAc);
        query.setParameter( "name", name.toString());
        query.setParameter( "id", processId);
    ...
    public List<T> getAllProteinEventsByNameAndDate(EventName name, Date updatedDate) {
        final Query query = getEntityManager().createQuery( "select pe from "+ this.getEntityClass().getName() +" pe join pe.parent as p where pe.name = :name and trunc(p.date) = trunc(:date)" );
        query.setParameter( "name", name.toString());
        query.setParameter( "date", updatedDate);
    ...
    public List<T> getAllProteinEventsByProteinAcAndDate(String proteinAc, Date updatedDate) {
        final Query query = getEntityManager().createQuery( "select pe from "+ this.getEntityClass().getName() +" pe join pe.parent as p where p.proteinAc = :ac and trunc(p.date) = trunc(:date)" );
        query.setParameter( "ac", proteinAc);
        query.setParameter( "date", updatedDate);
    ...
    public List<T> getProteinEventsByNameAndProteinAc(EventName name, String proteinAc, Date date) {
        final Query query = getEntityManager().createQuery( "select pe from "+ this.getEntityClass().getName() +" pe join pe.parent as p where pe.name = :name and p.proteinAc = :ac and trunc(p.date) = trunc(:date)" );
        query.setParameter( "name", name.toString());
        query.setParameter( "ac", proteinAc);
