...
public class MappingReportDaoImplTest extends UpdateBasicTestCase {
    ...
    public void test_GetActionReportByNameAndProteinAc_successful() throws Exception {
        ...
        List<MappingReport> list = actionReportDao.getActionReportsByNameAndProteinAc(ActionName.PICR_accession, "EBI-0001001");
    ...
    public void test_GetActionReportsByNameAndProteinAc_unsuccessful() throws Exception {
        ...
        List<MappingReport> list = actionReportDao.getActionReportsByNameAndProteinAc(ActionName.PICR_sequence_Swissprot, "EBI-0001001");
    ...
    public void test_GetActionReportByStatusAndProteinAc_successful() throws Exception {
        ...
        List<MappingReport> list = actionReportDao.getActionReportsByStatusAndProteinAc(StatusLabel.COMPLETED, "EBI-0001001");
    ...
    public void test_GetUActionReportsByStatusAndProteinAc_unsuccessful() throws Exception {
        ...
        List<MappingReport> list = actionReportDao.getActionReportsByStatusAndProteinAc(StatusLabel.TO_BE_REVIEWED, "EBI-0001001");
    ...
    public void test_GetReportsWithWarningsByProteinAc_successful() throws Exception {
        ...
        List<MappingReport> list = actionReportDao.getActionReportsWithWarningsByProteinAc("EBI-0001001");
