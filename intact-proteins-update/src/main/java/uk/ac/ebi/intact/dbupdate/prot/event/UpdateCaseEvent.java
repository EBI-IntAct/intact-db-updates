...
public class UpdateCaseEvent extends EventObject implements ProteinProcessorEvent{
    ...
    private List<XrefUpdaterReport> xrefUpdaterReports = new ArrayList<>();
    private List<AliasUpdateReport> aliasUpdaterReports = new ArrayList<>();
    private List<ProteinNameUpdateReport> nameUpdateReports = new ArrayList<>();
    private Map<String, Collection<Annotation>> newAnnotations = new HashMap<>();
